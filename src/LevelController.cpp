...
void LevelController::initBackground()
{
	//frame image
	auto frameSize = sf::Vector2u(ObjectSpace * ObjectFactor.x * (m_levelMap[m_LevelNum][0].size() + 3), ObjectSpace * ObjectFactor.y * (m_levelMap[m_LevelNum].size() + 3));
...
bool LevelController::isInsideBoard(int movingObject) const
{
